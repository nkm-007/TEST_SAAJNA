...
import { AIChatbox } from "@/components/task/ai-chatbox";
import {
  useAchievedTaskMutation,
  useTaskByIdQuery,
  useWatchTaskMutation,
  useDeleteTaskMutation,
  useTaskFiles, // ✅ ADD THIS
} from "@/hooks/use-task";
import { useAuth } from "@/provider/auth-context";
import type { Project, Task } from "@/types";
import { formatDistanceToNow } from "date-fns";
import { Eye, EyeOff, Bot, MoreVertical, Archive } from "lucide-react";
...
const TaskDetails = () => {
  ...
  // ✅ Function to trigger file refresh
    ...
    <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 py-4">
          ...
          {!isClient && (
            <>
              ...
              <div className="sm:hidden flex items-center gap-2">
                {/* ✅ Google Drive Upload Button for mobile */}
                {task._id && (
                  <FileUploadButtonDrive
                    taskId={task._id}
                    onUploadSuccess={handleUploadSuccess}
      ...
      <div className="flex flex-col lg:flex-row lg:items-start gap-6 mt-6">
        ...
        <div className="w-full lg:w-80 xl:w-96 flex-shrink-0 space-y-6">
          ...
          {/* ✅ TaskFiles component - no need for refreshKey anymore */}
          <TaskFiles taskId={task._id} isClient={isClient} />
        </div>
      </div>

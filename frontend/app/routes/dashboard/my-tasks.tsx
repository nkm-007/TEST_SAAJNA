                ...
                {todoTasks?.map((task) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex flex-col md:flex-row items-start md:items-center md:justify-start mt-2 gap-2">
                        <Badge
                          variant={
                            task.priority === "High"
                              ? "destructive"
                ...
                {inProgressTasks?.map((task) => (
                  ...
                  >
                    <Link
                      ...
                      className="block"
                    >
                      <h3 className="font-medium text-sm md:text-base text-center md:text-left">
                        {task.title}
                      </h3>
                      <p className="text-xs md:text-sm text-muted-foreground line-clamp-3 text-center md:text-left mt-1">
                        {task.description || "No description"}
                      </p>

                      <div className="flex flex-col md:flex-row items-center justify-center md:justify-start mt-2 gap-2">
                        <Badge
                          variant={
                            task.priority === "High"
                              ? "destructive"
